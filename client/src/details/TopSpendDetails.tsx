            ...
            <PageLayout >
                <NavBar />
                 <Flex 
                  ...
                  ml="20px"
                  mr="30px">
                    <TopExpenditure categoryInfo={topSpendCat[0]} catEntries={cat1Entries} />
                    <TopExpenditure categoryInfo={topSpendCat[1]} catEntries={cat2Entries} />
                  </Flex>
                  <Flex 
                  h="500px"
                  direction="row"
                  ...
                  ml="20px"
                  mr="30px">
                    <TopExpenditure categoryInfo={topSpendCat[2]} catEntries={cat3Entries} />
                    <TopExpenditure categoryInfo={topSpendCat[3]} catEntries={cat4Entries} />
                  </Flex>
            </PageLayout>
        )
    } else {
